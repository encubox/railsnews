...
!!! Patched by sigmaray. ALPIXEL is group of idiots.
...
(function($) {
	$.fn.jRating = function(op) {
		var defaults = {
			/** String vars **/
			bigStarsPath : '/images/jRating.jquery/stars.png', // path of the icon stars.png
			smallStarsPath : '/images/jRating.jquery/small.png', // path of the icon small.png
